#!/bin/bash
# ==============================================================================
# ATShogi ➡ ATShogi-Android (AArch64) 一気通貫自動ビルド＆自動配備スクリプト (v16)
# ==============================================================================
set -e
...
echo "===================================================================="
echo "    ATShogi-OM Extreme V16: Fully Autonomous Build & Deploy Pipeline"
echo "===================================================================="

# 1. Makefile を使用してクロスコンパイル、定跡自律生成、転送、およびハッシュ動的比較を完全自律実行
make -f Makefile-v16 clean
make -f Makefile-v16 deploy_all

echo "===================================================================="
echo "    Deploy Pipeline (v16) Complete! Ready for Android Studio Run."
echo "===================================================================="
